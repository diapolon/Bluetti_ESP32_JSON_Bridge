...
#define DEVICE_NAME "BLUETTI-Bridge"
...
#define MAX_DISCONNECTED_TIME_UNTIL_REBOOT 5 //device will reboot when wlan/BT is not connectet within x Minutes
...
#define MSG_VIEWER_DETAILS 0 //enable detailed BT messages via WebUI by default, can be changed in WebUI
